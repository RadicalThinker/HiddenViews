...
// HTML-escape interpolated user input before embedding in the email body —
// without this, a `<script>` payload in `name` could be HTML-injected into
// the email. `message` was already escaped only via \n-><br>.
